...
* Claude Code as a CLI agent now supported. Mix and match: spawn claude code from within claude code, or claude code from within codex.
* Full code can now be generated by an external model and shared with the AI tool (Claude Code / Codex etc)!
* Huge update - Link another CLI (such as `gemini` directly from with Claude Code / Codex). https://github.com/BeehiveInnovations/zen-mcp-server/issues/208
...
* Add Claude Opus 4.5 model via OpenRouter ([483c67e](https://github.com/laurigates/pal-mcp-server/commit/483c67edb71e88d18e88b15d7fecaa1d205074da))
* Add Claude Opus 4.5 model via OpenRouter ([813ce5c](https://github.com/laurigates/pal-mcp-server/commit/813ce5c9f7db2910eb12d8c84d3d99f464c430ed))
* add Claude Sonnet 4.5 and update alias configuration ([95c4822](https://github.com/laurigates/pal-mcp-server/commit/95c4822af2dc55f59c0e4ed9454673d6ca964731))
* Add comprehensive GPT-5 series model support ([4930824](https://github.com/laurigates/pal-mcp-server/commit/493082405237e66a2f033481a5f8bf8293b0d553))
* add configurable environment variable override system ([5475400](https://github.com/laurigates/pal-mcp-server/commit/54754002ac3f7546e1ebdbc7e8981c022ab82af2))
* add configurable environment variable override system ([93ce698](https://github.com/laurigates/pal-mcp-server/commit/93ce6987b6e7d8678ffa5ac51f5106a7a21ce67b))
* add custom Gemini endpoint support ([48885e7](https://github.com/laurigates/pal-mcp-server/commit/48885e7a5bdf32370b686ac5180eaf82b0fd8e0e))
* add custom Gemini endpoint support ([462bce0](https://github.com/laurigates/pal-mcp-server/commit/462bce002e2141b342260969588e69f55f8bb46a))
* add GPT-5-Codex support with Responses API integration ([775ac8f](https://github.com/laurigates/pal-mcp-server/commit/775ac8ff58c78268c90f366f9b665c33b7642028))
* add GPT-5-Codex support with Responses API integration ([f265342](https://github.com/laurigates/pal-mcp-server/commit/f2653427ca829368e7145325d20a98df3ee6d6b4))
* add grok-4 to openrouter_models.json ([a33efbd](https://github.com/laurigates/pal-mcp-server/commit/a33efbde520dee5e174897a4e032255effd877a5))
* add new GPT-5.1 models to configuration files and update model selection logic in OpenAI provider ([8e9aa23](https://github.com/laurigates/pal-mcp-server/commit/8e9aa2304d5e9ea9a9f8dc2a13a27a1ced6b1608))
* add new models released since Dec 2025 ([da61d72](https://github.com/laurigates/pal-mcp-server/commit/da61d72cc7271701d2aa3a755eb74653ca8b383b))
* add new models released since Dec 2025 (Opus 4.7, GPT-5.5, Gemini 3.5 Flash, etc.) ([d8c674e](https://github.com/laurigates/pal-mcp-server/commit/d8c674e8fd67b34ee63c5da2c85b87788e4917c1))
* add OpenAI GPT-5.1 family support ([ba63892](https://github.com/laurigates/pal-mcp-server/commit/ba63892ae2e01b9484bb0e7cce50f6fcc456af90))
* add semantic PR validation workflow ([a5597bb](https://github.com/laurigates/pal-mcp-server/commit/a5597bbcde03acf6c4b13e8a60ed48a7c113f56f))
* add support for openai/gpt-5-pro model ([3bfe250](https://github.com/laurigates/pal-mcp-server/commit/3bfe2507fec97ee9df25ef0d16997e40280d454b))
* add support for openai/gpt-5-pro model ([abed075](https://github.com/laurigates/pal-mcp-server/commit/abed075b2eaa99e9618202f47ff921094baae952))
* added `intelligence_score` to the model capabilities schema; a 1-20 number that can be specified to influence the sort order of models presented to the CLI in `auto selection` mode ([6cab9e5](https://github.com/laurigates/pal-mcp-server/commit/6cab9e56fc5373da5c11d4545bcb85371d4803a4))
* Added support for gpt-5-codex from openrouter ([3d266fe](https://github.com/laurigates/pal-mcp-server/commit/3d266fe5f5342efd4714d78d804513289c756ba7))
* all native providers now read from catalog files like OpenRouter / Custom configs. Allows for greater control over the capabilities ([2a706d5](https://github.com/laurigates/pal-mcp-server/commit/2a706d5720c0bf97b71c3e0fc95c15f78015bedf))
* Azure OpenAI / Azure AI Foundry support. Models should be defined in conf/azure_models.json (or a custom path). See .env.example for environment variables or see readme. https://github.com/BeehiveInnovations/zen-mcp-server/issues/265 ([ff9a07a](https://github.com/laurigates/pal-mcp-server/commit/ff9a07a37adf7a24aa87c63b3ba9db88bdff467b))
* breaking change - OpenRouter models are now read from conf/openrouter_models.json while Custom / Self-hosted models are read from conf/custom_models.json ([ff9a07a](https://github.com/laurigates/pal-mcp-server/commit/ff9a07a37adf7a24aa87c63b3ba9db88bdff467b))
* centralized environment handling, ensures ZEN_MCP_FORCE_ENV_OVERRIDE is honored correctly ([2c534ac](https://github.com/laurigates/pal-mcp-server/commit/2c534ac06e4c6078b96781dfb55c5759b982afe8))
* **chat:** contain artifact writes and fix prompt-injection sink ([#27](https://github.com/laurigates/pal-mcp-server/issues/27)) ([0e87410](https://github.com/laurigates/pal-mcp-server/commit/0e8741019ee38f4472e8443de7cb73699d1eaf08))
* Claude Code as a CLI agent now supported. Mix and match: spawn claude code from within claude code, or claude code from within codex. ([4cfaa0b](https://github.com/laurigates/pal-mcp-server/commit/4cfaa0b6060769adfbd785a072526a5368421a73))
* Codex CLI support ([ce56d16](https://github.com/laurigates/pal-mcp-server/commit/ce56d16240ddcc476145a512561efe5c66438f0d))
* codex supports web-search natively but needs to be turned on, run-server script asks if the user would like this done ([97ba7e4](https://github.com/laurigates/pal-mcp-server/commit/97ba7e44ce7e3fd874759514ed2f0738033fc801))
* Continue Python environment setup even without API keys ([e67a66f](https://github.com/laurigates/pal-mcp-server/commit/e67a66f582a34773cfb96eeb39d21e31846e3c8e))
* depending on the number of tools in use, this change should save ~50% of overall tokens used. fixes https://github.com/BeehiveInnovations/zen-mcp-server/issues/255 but also refactored individual tools to instead encourage the agent to use the listmodels tool if needed. ([d9449c7](https://github.com/laurigates/pal-mcp-server/commit/d9449c7bb607caff3f0454f210ddfc36256c738a))
* enhance model support by adding GPT-5.1 to .gitignore and updating cassette maintenance documentation for dual-model testing ([f713d8a](https://github.com/laurigates/pal-mcp-server/commit/f713d8a354a37c32a806c98994e6f949ecd64237))
* enhance review prompts to emphasize static analysis ([36e66e2](https://github.com/laurigates/pal-mcp-server/commit/36e66e2e9a44a73a466545d4d3477ecb2cb3e669))
* Full code can now be generated by an external model and shared with the AI tool (Claude Code / Codex etc)! ([ece8a5e](https://github.com/laurigates/pal-mcp-server/commit/ece8a5ebedb70798ced4ed6f6aae9bfb93be1c21))
* gemini 3.0 pro preview added (as default gemini pro model) ([25fd72f](https://github.com/laurigates/pal-mcp-server/commit/25fd72fbd3cbcd3c2bb98466e54f73f910f16fa2))
* Gemini 3.0 Pro Preview for Open Router ([bbfdfac](https://github.com/laurigates/pal-mcp-server/commit/bbfdfac511668e8ae60f9b9b5d41eb9ab55d74cf))
* GPT-5.2 support ([8b16405](https://github.com/laurigates/pal-mcp-server/commit/8b16405f0609e232ff808361dc2a4d8ec258b0f3))
* gpt5-codex support via native / OpenRouter config (via PRs) ([3533568](https://github.com/laurigates/pal-mcp-server/commit/3533568e79a26bbcd0c819b1f1d2b5a3b22e0947))
* grok-4.1 support https://github.com/BeehiveInnovations/pal-mcp-server/issues/339 ([514c9c5](https://github.com/laurigates/pal-mcp-server/commit/514c9c58fcc91933348d2188ed8c82bbe98132f2))
* Huge update - Link another CLI (such as `gemini` directly from with Claude Code / Codex). https://github.com/BeehiveInnovations/zen-mcp-server/issues/208 ([a2ccb48](https://github.com/laurigates/pal-mcp-server/commit/a2ccb48e9a5080a75dbfd483b5f09fc719c887e5))
* implement semantic cassette matching for o3 models ([70fa088](https://github.com/laurigates/pal-mcp-server/commit/70fa088c32ac4e6153d5e7b30a3e32022be2f908))
* improved prompt ([b1e9963](https://github.com/laurigates/pal-mcp-server/commit/b1e9963991a41dff082ec1dce5691c318f105e6d))
* improvements to precommit ([2966dcf](https://github.com/laurigates/pal-mcp-server/commit/2966dcf2682feb7eef4073738d0c225a44ce0533))
* minor tweaks to chat system prompt to help with alignment ([a8fbafd](https://github.com/laurigates/pal-mcp-server/commit/a8fbafd5a758122855dcab52e4d3d2bf49d83dbf))
* more aliases ([5f0aaf5](https://github.com/laurigates/pal-mcp-server/commit/5f0aaf5f69c9d188d817b5ffbf6738c61da40ec7))
* new tool to perform apilookup (latest APIs / SDKs / language features etc) https://github.com/BeehiveInnovations/zen-mcp-server/issues/204 ([5bea595](https://github.com/laurigates/pal-mcp-server/commit/5bea59540f58b3c45044828c10f131aed104dd1c))
* OpenAI/compatible models (such as Azure OpenAI) can declare if they use the response API instead via `use_openai_responses_api` ([3824d13](https://github.com/laurigates/pal-mcp-server/commit/3824d131618683572e9e8fffa6b25ccfabf4cf50))
* OpenRouter / Custom Models / Azure can separately also use custom config paths now (see .env.example ) ([ff9a07a](https://github.com/laurigates/pal-mcp-server/commit/ff9a07a37adf7a24aa87c63b3ba9db88bdff467b))
* optimize PR Docker build to only run for relevant changes ([bbf4afa](https://github.com/laurigates/pal-mcp-server/commit/bbf4afa3278968f03ae9ffe436e0cc706b5f89ff))
* provider cleanup ([9268dda](https://github.com/laurigates/pal-mcp-server/commit/9268ddad2a07306351765b47098134512739f49f))
* **providers:** make generate_content async via asyncio.to_thread ([#36](https://github.com/laurigates/pal-mcp-server/issues/36)) ([83adaa6](https://github.com/laurigates/pal-mcp-server/commit/83adaa6d2d242051ac070de65cfad93e27aa457a))
* re-enable web search for clink codex using correct --enable flag ([1be1d98](https://github.com/laurigates/pal-mcp-server/commit/1be1d982b28886103b1b302198df5165654a2afa))
* re-enable web search for clink codex using correct --enable flag ([e7b9f3a](https://github.com/laurigates/pal-mcp-server/commit/e7b9f3a5d7e06c690c82b9fd13a93310bcf388ed))
* refactored and improved codereview in line with precommit. Reviews are now either external (default) or internal. Takes away anxiety and loss of tokens when Claude incorrectly decides to be 'confident' about its own changes and bungle things up. ([80d21e5](https://github.com/laurigates/pal-mcp-server/commit/80d21e57c0246762c0a306ede5b93d6aeb2315d8))
* refactored and tweaked model descriptions / schema to use fewer tokens at launch (average reduction per field description: 60-80%) without sacrificing tool effectiveness ([4b202f5](https://github.com/laurigates/pal-mcp-server/commit/4b202f5d1d24cea1394adab26a976188f847bd09))
* **release:** switch from python-semantic-release to release-please ([77d16e8](https://github.com/laurigates/pal-mcp-server/commit/77d16e8d47baebda7b72cb8ffb4419d6cbf35c58))
* streamline docker-pr workflow with label support ([31585b3](https://github.com/laurigates/pal-mcp-server/commit/31585b3bfa39255925582c6f32a6b5350558c192))
* streamline GitHub Actions workflows and improve contributor experience ([027c734](https://github.com/laurigates/pal-mcp-server/commit/027c734c64fa045c55915c6e5bf8182344d29692))
* streamline GitHub Actions workflows and improve contributor experience ([af3a815](https://github.com/laurigates/pal-mcp-server/commit/af3a81543c38eebc210b508ace84673a1c2db2b7))
* support for codex as external CLI ([561e4aa](https://github.com/laurigates/pal-mcp-server/commit/561e4aaaa8a89eb89c03985b9e7720cc98ef666c))
* support for GPT-5-Pro highest reasoning model https://github.com/BeehiveInnovations/zen-mcp-server/issues/275 ([a65485a](https://github.com/laurigates/pal-mcp-server/commit/a65485a1e52fc79739000426295a27d096f4c9d8))
* support for Qwen Code ([fe9968b](https://github.com/laurigates/pal-mcp-server/commit/fe9968b633d0312b82426e9ebddfe1d6515be3c5))
* support native installed Claude CLI detection ([283c9fa](https://github.com/laurigates/pal-mcp-server/commit/283c9fa938a5ec653f9e8d2770b113e2e7b9eba5))
* support native installed Claude CLI detection ([adc6231](https://github.com/laurigates/pal-mcp-server/commit/adc6231b98886f0bc35cb04d04d948eba2f0f058)), closes [#303](https://github.com/laurigates/pal-mcp-server/issues/303)
* Update Claude models to Opus 4.1 and Sonnet 4.1 ([a4e31e2](https://github.com/laurigates/pal-mcp-server/commit/a4e31e25e9627db08a447f0555c9e5947f222f0f))
* Update Claude models to Opus 4.1 and Sonnet 4.1 ([0959d6f](https://github.com/laurigates/pal-mcp-server/commit/0959d6f0fa3ae063b10dbb367c15fdc6681c0173))


### Bug Fixes

* --yolo needed for running shell commands, documentation added ([15ae3f2](https://github.com/laurigates/pal-mcp-server/commit/15ae3f24babccf42f43be5028bf8c60c05a6beaf))
* add GPT-5-Codex to Responses API routing and simplify comments ([82b021d](https://github.com/laurigates/pal-mcp-server/commit/82b021d75acc791e68c7afb35f6492f68cf02bec))
* Add JSON output flag to gemini CLI configuration ([eb3dff8](https://github.com/laurigates/pal-mcp-server/commit/eb3dff845828f60ff2659586883af622b8b035eb))
* add sonnet alias for Claude Sonnet 4.1 to match opus/haiku pattern ([dc96344](https://github.com/laurigates/pal-mcp-server/commit/dc96344db043e087ee4f8bf264a79c51dc2e0b7a))
* address PR review feedback on test quality ([ee52082](https://github.com/laurigates/pal-mcp-server/commit/ee520825b46c3fcd5609c90cd5d2e15db045e002))
* address test failures and PR feedback ([6bd9d67](https://github.com/laurigates/pal-mcp-server/commit/6bd9d6709acfb584ab30a0a4d6891cabdb6d3ccf))
* align PR template with actual semantic-release and Docker workflows ([9f5c77f](https://github.com/laurigates/pal-mcp-server/commit/9f5c77fbadd517dd2b4e77fcd10eda83c5014c72))
* allow home subdirectories through is_dangerous_path() ([e5548ac](https://github.com/laurigates/pal-mcp-server/commit/e5548acb984ca4f8b2ae8381f879a0285094257f))
* another fix for https://github.com/BeehiveInnovations/zen-mcp-server/issues/251 ([a07036e](https://github.com/laurigates/pal-mcp-server/commit/a07036e6805042895109c00f921c58a09caaa319))
* baseclass should return MODEL_CAPABILITIES ([82a03ce](https://github.com/laurigates/pal-mcp-server/commit/82a03ce63f28fece17bfc1d70bdb75aadec4c6bb))
* **build:** include clink resources in package ([433a67d](https://github.com/laurigates/pal-mcp-server/commit/433a67defd4e0e1418e866906d68ae01536b0167))
* **build:** include clink resources in package ([e9ac1ce](https://github.com/laurigates/pal-mcp-server/commit/e9ac1ce3354fbb124a72190702618f94266b8459))
* CI test ([bc93b53](https://github.com/laurigates/pal-mcp-server/commit/bc93b5343bbd8657b95ab47c00a2cb99a68a009f))
* clink missing in toml ([1ff77fa](https://github.com/laurigates/pal-mcp-server/commit/1ff77faa800ad6c2dde49cad98dfa72035fe1c81))
* configure codex with a longer timeout ([d2773f4](https://github.com/laurigates/pal-mcp-server/commit/d2773f488af28986632846652874de9ff633049c))
* consensus now advertises a short list of models to avoid the CLI getting the names wrong ([8759edc](https://github.com/laurigates/pal-mcp-server/commit/8759edc817f1a20969cf2e4c2d7ff061a7c0eac7))
* continuation_id warning when using consensus ([d090d5a](https://github.com/laurigates/pal-mcp-server/commit/d090d5a88ee79e0d761c21b1c0206ea8ab45dd09))
* correct pre-commit global exclude pattern and remove redundant excludes ([fcaf0d6](https://github.com/laurigates/pal-mcp-server/commit/fcaf0d691755a973ca08c676fcf7fdd221d5a800))
* custom provider must only accept a model if it's declared explicitly. Upon model rejection (in auto mode) the list of available models is returned up-front to help with selection. ([d285fad](https://github.com/laurigates/pal-mcp-server/commit/d285fadf4cc1ab0189758a99fb24578fb6cc2c97))
* ensure generated code is not copied as-is, may contain partial code generated by the other model ([3acfffe](https://github.com/laurigates/pal-mcp-server/commit/3acfffe0f6654b342bf517a876e9929eebe0f605))
* escape backslashes in TOML regex pattern ([1c973af](https://github.com/laurigates/pal-mcp-server/commit/1c973afb002650b9bbee8a831b756bef848915a1))
* establish version 5.8.6 and add version sync automation ([90a4195](https://github.com/laurigates/pal-mcp-server/commit/90a419538128b54fbd30da4b8a8088ac59f8c691))
* external model name now recorded properly in responses ([d55130a](https://github.com/laurigates/pal-mcp-server/commit/d55130a430401e106cd86f3e830b3d756472b7ff))
* failing test ([aed3e3e](https://github.com/laurigates/pal-mcp-server/commit/aed3e3ee80c440ac8ab0d4abbf235b84df723d18))
* failing test for gemini 3.0 pro open router ([19a2a89](https://github.com/laurigates/pal-mcp-server/commit/19a2a89b12c5dec53aea21a4244aff7796a5e049))
* fixed adherence to `*_ALLOWED_MODELS` by advertising only the allowed models to the CLI ([6cab9e5](https://github.com/laurigates/pal-mcp-server/commit/6cab9e56fc5373da5c11d4545bcb85371d4803a4))
* fixed tests ([2a8dff0](https://github.com/laurigates/pal-mcp-server/commit/2a8dff0cc8a3f33111533cdb971d654637ed0578))
* gemini 3.0 pro does not currently support medium thinking level, updated to use high ([18464a8](https://github.com/laurigates/pal-mcp-server/commit/18464a8b54af603cc67a96f29ea21fef9d25e09d))
* grok test ([39c7721](https://github.com/laurigates/pal-mcp-server/commit/39c77215e5d6892269e523ff25b706dd5671c042))
* handle 429 response https://github.com/BeehiveInnovations/zen-mcp-server/issues/273 ([cbe1d79](https://github.com/laurigates/pal-mcp-server/commit/cbe1d7993276bd014b495cbd2d0ece1f5d7583d9))
* handle claude's array style JSON   https://github.com/BeehiveInnovations/zen-mcp-server/issues/295 ([d5790a9](https://github.com/laurigates/pal-mcp-server/commit/d5790a9bfef719f03d17f2d719f1882e55d13b3b))
* handle fork PR permissions in Docker workflow ([ce2e15e](https://github.com/laurigates/pal-mcp-server/commit/ce2e15e406cb928006f2ce3a63491db03499ad73))
* handler for parsing multiple generated code blocks ([f4c20d2](https://github.com/laurigates/pal-mcp-server/commit/f4c20d2a20e1c57d8b10e8f508e07e2a8d72f94a))
* https://github.com/BeehiveInnovations/zen-mcp-server/issues/194 ([8b3a286](https://github.com/laurigates/pal-mcp-server/commit/8b3a2867fb83eccb3a8e8467e7e3fc5b8ebe1d0c))
* https://github.com/BeehiveInnovations/zen-mcp-server/issues/251 added handling for safety_feedback from Gemini. `FinishReason.STOP` can be a hidden safety block from gemini or issued when it chooses not to respond. ([f89afd1](https://github.com/laurigates/pal-mcp-server/commit/f89afd1a725fdee54f316db44161a064578ca16f))
* https://github.com/BeehiveInnovations/zen-mcp-server/issues/258 ([696b45f](https://github.com/laurigates/pal-mcp-server/commit/696b45f25e80faccb67034254cf9a8fc4c643dbd))
* improved conversation retrieval ([4c288b2](https://github.com/laurigates/pal-mcp-server/commit/4c288b238577cf5319191d8cdbeb36334b9e8834))
* improved error reporting; codex cli would at times fail to figure out how to handle plain-text / JSON errors ([95e69a7](https://github.com/laurigates/pal-mcp-server/commit/95e69a7cb234305dcd37dcdd2f22be715922e9a8))
* improved handling of MCP token limits when handling CLI output ([561e4aa](https://github.com/laurigates/pal-mcp-server/commit/561e4aaaa8a89eb89c03985b9e7720cc98ef666c))
* improved initial instructions on using the listmodels tool ([1426277](https://github.com/laurigates/pal-mcp-server/commit/1426277ef8650ed25332d8ca3688d0bb1542f6d2))
* improved prompt for codex to avoid calling apilookup in a loop thinking it's a web-tool ([97ba7e4](https://github.com/laurigates/pal-mcp-server/commit/97ba7e44ce7e3fd874759514ed2f0738033fc801))
* intercept non-cli errors and allow agent to continue ([a150e1c](https://github.com/laurigates/pal-mcp-server/commit/a150e1c3121efcfd7cda8368ed38bee12b2713b3))
* listmodels to always honor restricted models ([4015e91](https://github.com/laurigates/pal-mcp-server/commit/4015e917ed32ae374ec6493b74993fcb34f4a971))
* listmodels tool cleanup ([693b84d](https://github.com/laurigates/pal-mcp-server/commit/693b84db2b87271ac809abcf02100eee7405720b))
* make sure openrouter provider does not load `is_custom` models ([693b84d](https://github.com/laurigates/pal-mcp-server/commit/693b84db2b87271ac809abcf02100eee7405720b))
* **memory:** distinguish missing thread from storage outage ([#32](https://github.com/laurigates/pal-mcp-server/issues/32)) ([acbe53f](https://github.com/laurigates/pal-mcp-server/commit/acbe53f9d91408feac1cbb10e6f3327ffdfc1cbc))
* **memory:** surface add_turn save failures via ConversationMemoryStorageError ([#40](https://github.com/laurigates/pal-mcp-server/issues/40)) ([b973e02](https://github.com/laurigates/pal-mcp-server/commit/b973e020ada45731ddb06b6ab006915f05ba9e37))
* missing "optenai/" in name ([7371ed6](https://github.com/laurigates/pal-mcp-server/commit/7371ed6487b7d90a1b225a67dca2a38c1a52f2ad))
* model definition re-introduced into the schema but intelligently and only a summary is generated per tool. Required to ensure CLI calls and uses the correct model ([6cab9e5](https://github.com/laurigates/pal-mcp-server/commit/6cab9e56fc5373da5c11d4545bcb85371d4803a4))
* path traversal vulnerability - use prefix matching in is_dangerous_path() ([9ed15f4](https://github.com/laurigates/pal-mcp-server/commit/9ed15f405a9462b4db7aa44ca2d989e092c008e4)), closes [#312](https://github.com/laurigates/pal-mcp-server/issues/312) [#293](https://github.com/laurigates/pal-mcp-server/issues/293)
* path traversal vulnerability in is_dangerous_path() ([2eb29b5](https://github.com/laurigates/pal-mcp-server/commit/2eb29b5a0f13e80c0f5c16d17e1efe057a6715e7))
* pip detection inconsistency in non-interactive shells ([123851d](https://github.com/laurigates/pal-mcp-server/commit/123851d50ac4a27e92200a2ebac6c82cd0763837))
* PR[#151](https://github.com/laurigates/pal-mcp-server/issues/151) - Enhance cross-platform support ([d969582](https://github.com/laurigates/pal-mcp-server/commit/d969582473b431ae8ee529639dd909009308006c))
* **providers:** omit store parameter for OpenRouter responses endpoint ([1f8b58d](https://github.com/laurigates/pal-mcp-server/commit/1f8b58d607c2809b9fa78860718a69207cb66e32)), closes [#348](https://github.com/laurigates/pal-mcp-server/issues/348)
* rebranding, see [docs/name-change.md](docs/name-change.md) for details ([b2dc849](https://github.com/laurigates/pal-mcp-server/commit/b2dc84992d70839b29b611178b3871f4922b747f))
* reduced token usage, removed parameters from schema that CLIs never seem to use ([3e27319](https://github.com/laurigates/pal-mcp-server/commit/3e27319e60b0287df918856b58b2bbf042c948a8))
* refactored dial provider to follow the same pattern ([7c36b92](https://github.com/laurigates/pal-mcp-server/commit/7c36b9255a13007a10af4fadefc21aadfce482b0))
* regression https://github.com/BeehiveInnovations/zen-mcp-server/issues/338 ([aceddb6](https://github.com/laurigates/pal-mcp-server/commit/aceddb655fc36918108b3da1f926bdd4e94875a2))
* remove duplicate -o json flag in gemini CLI config ([3b2eff5](https://github.com/laurigates/pal-mcp-server/commit/3b2eff58ac0e2388045a7442c63f56ce259b54ba))
* Remove duplicate OpenAI models from listmodels output ([c29e762](https://github.com/laurigates/pal-mcp-server/commit/c29e7623ace257eb45396cdf8c19e1659e29edb9))
* remove fork PR comment step due to permission restrictions ([ab397d7](https://github.com/laurigates/pal-mcp-server/commit/ab397d7b6a6d7add2e9764634054128b2417d032))
* removed `model` param from some tools where this wasn't needed ([6cab9e5](https://github.com/laurigates/pal-mcp-server/commit/6cab9e56fc5373da5c11d4545bcb85371d4803a4))
* Removed Duplicate Model Listings ([a262128](https://github.com/laurigates/pal-mcp-server/commit/a262128d00ca0266e5c466b3022ef882a22dad3e))
* removed duplicates across providers when passing canonical names back to the CLI; the first enabled provider wins ([6cab9e5](https://github.com/laurigates/pal-mcp-server/commit/6cab9e56fc5373da5c11d4545bcb85371d4803a4))
* removed use_websearch; this parameter was confusing Codex. It started using this to prompt the external model to perform searches! web-search is enabled by Claude / Codex etc by default and the external agent can ask claude to search on its behalf. ([cff6d89](https://github.com/laurigates/pal-mcp-server/commit/cff6d8998f64b73265c4e31b2352462d6afe377f))
* replaced deprecated Codex web search configuration ([2ec64ba](https://github.com/laurigates/pal-mcp-server/commit/2ec64ba7489acc586846b25eedf94a4f05d5bd2d))
* resolve consensus tool model_context parameter missing issue ([77caef6](https://github.com/laurigates/pal-mcp-server/commit/77caef6f54267854986aafd0ee034a3103b77686))
* resolve consensus tool model_context parameter missing issue ([9044b63](https://github.com/laurigates/pal-mcp-server/commit/9044b63809113047fe678d659e4fcd175f58e87a))
* resolve executable path for clink cross-platform compatibility in CLI ([d80d77b](https://github.com/laurigates/pal-mcp-server/commit/d80d77bb47190063c51200a348c69f434b3396cb))
* resolve executable path for cross-platform compatibility in CLI agent ([f98046c](https://github.com/laurigates/pal-mcp-server/commit/f98046c2fccaa7f9a24665a0d705a98006461da5)), closes [#276](https://github.com/laurigates/pal-mcp-server/issues/276)
* resolve logging timing and import organization issues ([d34c299](https://github.com/laurigates/pal-mcp-server/commit/d34c299f02a233af4f17bdcc848219bf07799723))
* resolve pip detection inconsistency in non-interactive shells ([7c6ec4a](https://github.com/laurigates/pal-mcp-server/commit/7c6ec4a92810173e6abf1d604a97fe2f05cfad4c)), closes [#188](https://github.com/laurigates/pal-mcp-server/issues/188)
* resolve temperature handling issues for O3/custom models ([#245](https://github.com/laurigates/pal-mcp-server/issues/245)) ([472c13b](https://github.com/laurigates/pal-mcp-server/commit/472c13bb2e2afeeba1f8524f0ae0ce14c036e429))
* resolve temperature handling issues for O3/custom models ([#245](https://github.com/laurigates/pal-mcp-server/issues/245)) ([3b4fd88](https://github.com/laurigates/pal-mcp-server/commit/3b4fd88d7e9a3f09fea616a10cb3e9d6c1a0d63b))
* respect custom OpenAI model temperature settings ([#245](https://github.com/laurigates/pal-mcp-server/issues/245)) ([ea299d1](https://github.com/laurigates/pal-mcp-server/commit/ea299d18f513ebd825257e037b90490af0d1aa67))
* respect custom OpenAI model temperature settings ([#245](https://github.com/laurigates/pal-mcp-server/issues/245)) ([2db1323](https://github.com/laurigates/pal-mcp-server/commit/2db1323813b3b4e47c9c754fa41660e02222b23b))
* restore proper version 5.8.6 ([340b58f](https://github.com/laurigates/pal-mcp-server/commit/340b58f2e790b84c3736aa96df7f6f5f2d6a13c9))
* restore run-server quote trimming regex ([1de4542](https://github.com/laurigates/pal-mcp-server/commit/1de454224c105891137134e2a25c2ee4f00dba45))
* restrictions should resolve canonical names for openrouter ([4015e91](https://github.com/laurigates/pal-mcp-server/commit/4015e917ed32ae374ec6493b74993fcb34f4a971))
* **security:** handle macOS symlinked system dirs ([ba08308](https://github.com/laurigates/pal-mcp-server/commit/ba08308a23d1c1491099c5d0eae548077bd88f9f))
* sed usage https://github.com/BeehiveInnovations/zen-mcp-server/issues/287 ([d36489f](https://github.com/laurigates/pal-mcp-server/commit/d36489fdc9008ced1d1411a6e2073c569dda1912))
* **server:** align backupCount values with their byte-budget comments ([#23](https://github.com/laurigates/pal-mcp-server/issues/23)) ([3be15a8](https://github.com/laurigates/pal-mcp-server/commit/3be15a81e51f759d24c1781d6745023d18357133))
* **server:** iterate provider instances during shutdown ([0e4d4df](https://github.com/laurigates/pal-mcp-server/commit/0e4d4dfe7d0dc6a5c669e5bf0fbfa91f2e9bf796))
* **server:** iterate provider instances during shutdown ([d40fc83](https://github.com/laurigates/pal-mcp-server/commit/d40fc83d7549293372f3d20cc599a79ec355acef))
* **server:** narrow activity-logger except Exception swallows ([#39](https://github.com/laurigates/pal-mcp-server/issues/39)) ([08cbd08](https://github.com/laurigates/pal-mcp-server/commit/08cbd08adc6ff4cae996ad6408f64e4b744d3fa6))
* stronger wording around model name usage ([eb0afe1](https://github.com/laurigates/pal-mcp-server/commit/eb0afe1ab803f6d1f1b0a260457c512bace759f8))
* telemetry option no longer available in gemini 0.11 ([2a8dff0](https://github.com/laurigates/pal-mcp-server/commit/2a8dff0cc8a3f33111533cdb971d654637ed0578))
* tests updated to ensure these manage their expected env vars properly ([4015e91](https://github.com/laurigates/pal-mcp-server/commit/4015e917ed32ae374ec6493b74993fcb34f4a971))
* **tests:** await AsyncMock returns in test_consensus and test_workflow_utf8 ([#29](https://github.com/laurigates/pal-mcp-server/issues/29)) ([38c1724](https://github.com/laurigates/pal-mcp-server/commit/38c1724e70ddafc51cad7754df487106bd0e0b7a))
* tools now correctly return restricted list by presenting model names in schema ([4015e91](https://github.com/laurigates/pal-mcp-server/commit/4015e917ed32ae374ec6493b74993fcb34f4a971))
* Update Claude CLI commands to new mcp syntax ([a2189cb](https://github.com/laurigates/pal-mcp-server/commit/a2189cb88a295ebad6268b9b08c893cd65bc1d89))
* updated model description to fix test ([04f7ce5](https://github.com/laurigates/pal-mcp-server/commit/04f7ce5b03804564263f53a765931edba9c320cd))
* updated tests to override env variables they need instead of relying on the current values from .env ([2c534ac](https://github.com/laurigates/pal-mcp-server/commit/2c534ac06e4c6078b96781dfb55c5759b982afe8))
* use CUSTOM_CONNECT_TIMEOUT for gemini too ([a33efbd](https://github.com/laurigates/pal-mcp-server/commit/a33efbde520dee5e174897a4e032255effd877a5))
* use Path.is_relative_to() for cross-platform dangerous path detection ([91ffb51](https://github.com/laurigates/pal-mcp-server/commit/91ffb51564e5655ec91111938039ed81e0d8e4c6))
* use types.HttpOptions from module imports instead of local import ([956e8a6](https://github.com/laurigates/pal-mcp-server/commit/956e8a6927837f5c7f031a0db1dd0b0b5483c626))
* uvx resource packaging issues for OpenRouter functionality ([e6213d4](https://github.com/laurigates/pal-mcp-server/commit/e6213d4ca17c3e0b4bd822013700dff4f7b2f77c))
* version ([2966dcf](https://github.com/laurigates/pal-mcp-server/commit/2966dcf2682feb7eef4073738d0c225a44ce0533))


### Performance

* cache model alias resolution to avoid repeated checks ([4015e91](https://github.com/laurigates/pal-mcp-server/commit/4015e917ed32ae374ec6493b74993fcb34f4a971))
* tweaks to schema descriptions, aiming to reduce token usage without performance degradation ([cc8a4df](https://github.com/laurigates/pal-mcp-server/commit/cc8a4dfd21b6f3dae4972a833b619e53c964693b))
