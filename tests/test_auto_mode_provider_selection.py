...
class TestAutoModeProviderSelection:
    ...
    def test_gemini_only_fallback_selection(self):
        ...
        try:
            ...
            assert fast_response in ["gemini-3.8-flash", "gemini-3.5-flash", "gemini-2.5-flash", "flash"]
            assert balanced in ["gemini-3.8-flash", "gemini-3.5-flash", "gemini-2.5-flash", "flash"]
    ...
    def test_openai_only_fallback_selection(self):
        ...
        try:
            ...
            assert balanced == "gpt-5.5"  # gpt-5.5 (new flagship) for balanced
