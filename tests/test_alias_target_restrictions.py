...
class TestAliasTargetRestrictions:
    ...
    def test_gemini_alias_target_validation_comprehensive(self):
        ...
        assert "gemini-3.7-flash" in all_known  # target of 'flash'
    ...
    @patch.dict(os.environ, {"GOOGLE_ALLOWED_MODELS": "gemini-3.7-flash"})  # Allow target
    def test_gemini_restriction_policy_allows_alias_when_target_allowed(self):
        ...
        assert provider.validate_model_name("gemini-3.7-flash")
    ...
    def test_restriction_validation_uses_polymorphic_interface(self):
        ...
        # that rather than letting a bare MagicMock answer truthy to everything.
        # This assertion (list_models called) does NOT depend on it --
